    ...
    <main className="profile">
      <div className="profile-container">
        <aside className="profile-details">
          ...
          {userData.linkedAccounts && <Dropdown linkedAccounts={userData.linkedAccounts}/>}
          {userData.linkedAccounts.length >=1 ? <Link to='/link-account'>Link another account</Link> : <Link to='/link-account'>Link a gaming account</Link>}
